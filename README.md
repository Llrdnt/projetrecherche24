Données actuellement récoltées dans le cadre d'un projet de recherche sur les dynamiques sociales numériques. Ces dernières sont issues de différents boards (8chan & EndChan):
